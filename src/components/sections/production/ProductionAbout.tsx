            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <div className="mb-8 rounded-xl overflow-hidden border dark:border-white/10 border-black/10 shadow-lg relative h-24 w-full max-w-md">
                            <CloudinaryImage
                                src="l3_b68e4a"
                        ...
                        <div className="flex flex-wrap gap-4 mt-8 mb-8">
                            <div className="flex items-center gap-2 dark:bg-white/5 bg-black/5 px-4 py-2 rounded-lg border dark:border-white/10 border-black/10">
                        ...
                        <Link href="/gallery/post-production" className="inline-flex items-center gap-2 px-8 py-4 bg-blue-600 dark:text-white text-black rounded-full font-bold text-lg hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/25">
                    ...
                    >
                        <div className="aspect-square md:aspect-video rounded-2xl overflow-hidden shadow-2xl border dark:border-white/10 border-black/10 dark:bg-gray-800 bg-gray-50 relative group flex items-center justify-center">
                            ...
                            <div className="z-10 text-center p-6 relative flex flex-col items-center">
                                ...
                                <h3 className="text-3xl font-bold dark:text-white text-black tracking-wide">Leisure Film Studio</h3>
                                <p className="dark:text-gray-400 text-gray-600 mt-2 font-medium">Professional Post-Production</p>
                            </div>
                        </div>
                        {/* Decorative elements */}
